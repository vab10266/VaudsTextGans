...
if_test = int(False)
run_model = ['catgan', 'catgan', 'catgan', 'catgan', 'evogan', 'evogan', 'evogan']
k_label = 10
CUDA = int(True)
...
# ===Oracle or Real===
if_real_data = [int(True), int(False), int(True), int(True), int(False), int(True), int(True)]
dataset = ['amazon', 'oracle', 'mr15', 'amazon_app_book', 'oracle', 'image_coco', 'emnlp_news']
vocab_size = [0, 5000, 0, 0, 5000, 0, 0]
...
eval_type = 'Ra'
temp_adpt = 'exp'
temperature = [1, 1, 100, 100, 1, 100, 100]
d_out_mean = int(True)
lambda_fq = 1.0
lambda_fd = 0.001
eval_b_num = 8
...
mem_slots = 1
num_heads = 2
head_size = [512, 512, 512, 512, 256, 256, 256]
